...
const panels: { id: SidebarPanel; label: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    label: 'Debug Log',
    icon: (
      // Stethoscope-ish glyph — easy to spot, signals "diagnostic".
      // Only present on debug-logs branch; never shipped to public.
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4 2v6a4 4 0 0 0 8 0V2" />
        <path d="M8 12a6 6 0 0 0 6 6 4 4 0 0 0 4-4v-2" />
